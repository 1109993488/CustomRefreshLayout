...
public class Simple1RefreshLayout extends BaseRefreshLayout{
    public Simple1RefreshLayout(Context context) {
        super(context);
    }

    public Simple1RefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
